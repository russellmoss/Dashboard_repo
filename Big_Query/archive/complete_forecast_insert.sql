...
-- Complete hybrid forecast generation with ARIMA + Propensity models
...
SELECT 
  ...
  c.sqls_lower,
  c.sqls_upper,
  -- Use segment-specific conversion rate from trailing_rates_features (calculates correctly with backoff)
  -- Falls back to 0.60 (Q3 2025 aggregate rate) if no trailing rate available
