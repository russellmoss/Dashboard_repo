-- ===================================================================
-- COMPLETE RETRAINING SCRIPT FOR HYBRID FORECAST SYSTEM
-- Date: October 30, 2025
-- Purpose: Retrain all models and generate production forecast
-- ===================================================================

-- STEP 0: Create logging table if it doesn't exist
CREATE TABLE IF NOT EXISTS `savvy-gtm-analytics.savvy_forecast.model_training_log`
(
  train_date DATE,
  train_type STRING,
  status STRING,
...
PARTITION BY train_date;

-- ===================================================================
-- STEP 1: Rebuild Trailing Rates Table (180-day lookback)
-- ===================================================================
...
daily_progressions AS (
  ...
  WHERE DATE(FilterDate) >= DATE_SUB(CURRENT_DATE(), INTERVAL 180 DAY)
  GROUP BY 1, 2, 3
),
target_dates AS (
...
-- ===================================================================
-- STEP 2: Rebuild Propensity Training Table (180-day window)
-- ===================================================================
...
-- ===================================================================
-- STEP 3: Retrain ARIMA Models (90-day window, 4 segments only)
-- ===================================================================
