...
FunnelWithFlags AS (
  SELECT
    *,
    ...
    -- UPDATED: Only include contacted leads with final outcome (became MQL or has Disposition__c) - excludes open contacted leads
    CASE 
      WHEN is_contacted = 1 
        AND (is_mql = 1 OR Disposition__c IS NOT NULL)
      THEN 1 
      ELSE 0 
