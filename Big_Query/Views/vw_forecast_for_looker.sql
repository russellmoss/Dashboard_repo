-- Forecast View Optimized for Looker Shotgun-Style Graphs
-- Provides forecast values with 50% confidence intervals by Original Source, Channel, and Date
-- Designed for time-series visualization with confidence bands that widen over time
--
-- Use Cases:
--   - Shotgun-style graphs with confidence intervals
...
SELECT
  ...
  -- Confidence interval width (for visualizations)
